<template>
    ...
    <div class="bg-gray-200/50 py-4 text-black-400">
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 my-4 w-full xl:w-1/5">
            <a href="/" class="block w-56 mb-10">
                <img src="/src/img/logo.jpeg" alt="OpenTalk" class="h-20 w-auto mr-10 rounded-full" >
            </a>
            <p class="text-justify">
            Tous vos contacts, sécurisés et accessibles en un clic. <br>
            <span>

            Ajoutez, gérez et retrouvez facilement vos coordonnées essentielles (téléphone, email, profils).
            Libérez-vous des carnets perdus et regroupez tout sur une interface ultra-rapide.
            </span>
          ...
          <div class="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">SERVICES</h2>
            </div>
            <ul class="text-gray-600 dark:text-gray-300">
              <li class="mb-2">
                <a href="/dashboard" class="hover:text-blue-400 transition-colors">Tableau de bord</a>
              </li>
              <li class="mb-2">
                <a href="/contacts" class="hover:text-blue-400 transition-colors">Mes contacts</a>
              </li>
              <li class="mb-2">
                <a href="/profile" class="hover:text-blue-400 transition-colors">Mon profil</a>
              </li>
               </ul>
          </div>
          <div class="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            <div>
              <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Suivez-nous</h2>
            </div>
